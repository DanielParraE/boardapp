...
VERSION = get_version('boardapp', '__init__.py')
...
setup(
    name='boardapp',
    version=VERSION,
    description="""test board app""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Daniel',
    author_email='',
    url='https://github.com/DanielParraE/boardapp',
    packages=find_packages(
        include=['boardapp', 'boardapp.*'],
        exclude=["*tests"],
    ),
