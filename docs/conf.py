...
"""
boardapp documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'boardapp',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/DanielParraE/boardapp",
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'test board app',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'boardapp'),
                os.path.join(root_path, 'boardapp/migrations')])
